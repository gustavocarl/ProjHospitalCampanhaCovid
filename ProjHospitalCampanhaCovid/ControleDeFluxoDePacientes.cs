...
namespace ProjHospitalCampanhaCovid
{
    internal class ControleDeFluxoDePacientes
    {
        ...
        public void CriarRelatorio(Paciente paciente)
        {
            ...
            Console.WriteLine("Data de Início dos Sintomas: ");
            Console.WriteLine("Exemplo: 01/01/2022");
            ...
            Console.WriteLine("Deseja Arquivar o Paciente");
            Console.WriteLine("1 - Sim\n2 - Não");
            ...
            do
            {
                ...
                if (opcao == "1")
                {
                    ListaDePacientesArquivados.Entrada(new Paciente(paciente, new Relatorio(temperatura, pressao, saturacao, dataInicioDosSintomas, comorbidades, quantidadeDeComorbidades)));
                    selecao = true;
                }
                else if (opcao == "2")
                {
                    FilaEmergencia.Entrada(new Paciente(paciente, new Relatorio(temperatura, pressao, saturacao, dataInicioDosSintomas, comorbidades, quantidadeDeComorbidades)));
                    selecao = true;
                }
                else if (opcao == "3")
                {
                    FilaCovid.Entrada(new Paciente(paciente, new Relatorio(temperatura, pressao, saturacao, dataInicioDosSintomas, comorbidades, quantidadeDeComorbidades)));
                    selecao = true;
                }
                else
                {
        ...
        public void InserirEmergencia()
        {
            ...
            Console.WriteLine("Quantidade de Comorbidades do Paciente: ");
            int quantidadeDeComorbidades = int.Parse(Console.ReadLine());
            FilaEmergencia.Entrada(new Paciente(nome, cpf, dataDeNascimento, new Relatorio(temperatura, pressao, saturacao, dataInicioSintomas, comorbidades, quantidadeDeComorbidades)));
        }
